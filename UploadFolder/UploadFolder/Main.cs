...
namespace UploadFolder
{
    public partial class Main : System.Windows.Forms.Form
    {
        ...
        List<string> SubFoldersPath = new List<string>();   // list for SubFoldersPath
        ...
        {
            if (CbDocumentlibrary.SelectedItem == "" || CbDocumentlibrary.SelectedItem == null)
            {
            ...
            else
            {
                ...
                //_________________________________Upload selected Folders ____________________________________________//
                SPUpload.UploadFoldersRecursively(Clientcontext,CBfoldername.Text , CbDocumentlibrary.SelectedItem.ToString(), Convert.ToInt32(CBfoldername.SelectedValue));
